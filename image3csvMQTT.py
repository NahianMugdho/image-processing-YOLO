...
# CONFIGURATION
# ============================================================
IMAGE_DIR = r"D:\mugdho\IOT\website\v3Test\client-SIde\client\images"         # Folder where Flask saves snapshots
CSV_FILE = "detection_log.csv"
CONF_THRESHOLD = 0.2
CHECK_INTERVAL = 5            # seconds

# MQTT BROKER CONFIGURATION
BROKER = "localhost"          # or your PC IP
PORT = 8883                   # TLS port
USERNAME = "admin"
PASSWORD = "StrongPassword123"
CA_CERT = "broker.crt"        # Certificate file
TOPIC = "lab/detections"      # topic name (change if needed)
